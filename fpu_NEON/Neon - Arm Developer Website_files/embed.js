...
return false;},getGenericLocation:function(){var cloudLocation=location.protocol+'//'+'nebula-cdn.kampyle.com/we/8144/onsite/generic1575988985489.js';var genericPath=(cloudLocation.match(/\/[a-zA-Z\d-]+\/\d+\/onsite\/generic\d{13}\.js$/)||[])[0];return window.KAMPYLE_EMBED.isOnPrem()?window.KAMPYLE_EMBED.getResourcesPrefix()+genericPath:cloudLocation;},getResourcesPrefix:function(){if(window.MDIGITAL_ON_PREM_PREFIX){return window.MDIGITAL_ON_PREM_PREFIX;}
